...
def get_args():
    ...
    parse.add_argument('--eps_decay', type=float, default=0.995, help='the exploration decay')
    ...
    parse.add_argument('--buffer_size', type=int, default=int(2**15), help='the size of the replay buffer. An episode is'
    ...
    parse.add_argument('--ann_length', type=float, default=800, help='the weighting factor b')
