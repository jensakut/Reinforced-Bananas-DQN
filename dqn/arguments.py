...
def get_args():
    ...
    parse.add_argument('--use_prioritized_experience_replay', type=bool, default=False, help='use prioritized experience replay to train the agent')
    ...
    parse.add_argument('--batch-size', type=int, default=256, help='the batch size of updating')
